...
// 16. Log the last genre of the first movie (using the length property of the array)
console.log(movies[0].genres[movies[0].genres.length - 1]);

// 17. Log the last genre of the second movie (using the length property of the array)
console.log(movies[1].genres[movies[1].genres.length - 1]);

// 18. Log all the genres of the first movie one by one
movies[0].genres.forEach((genre) => console.log(genre));

// 19. Log all the genres of the second movie one by one
movies[1].genres.forEach((genre) => console.log(genre));
...
movies.forEach((movie) => console.log(parseInt(movie.year) > 2017));
...
movies.forEach((movie) => console.log(movie.actors.length));

// 26. Log the number of genres in all three movies one by one
movies.forEach((movie) => console.log(movie.genres.length));
...
// 28. Log the name of all the movies with more than 1 actor
movies.forEach((movie) => {
